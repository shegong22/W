...
const labImage = "/W/assets/asian-cleanroom_8ac53ec9.jpg";

const homeSlides = [
  { slot: "home_hero_cleanroom", fallback: "/W/assets/tide-lab-hero-cleanroom_ffb4f311.jpg", kicker: "01 / GUANGZHOU FACILITY", title: <>Precision built<br /><em>into every stage.</em></>, body: "A Chinese peptide factory connecting R&D, production coordination, analytical documentation, and global supply.", action: "Explore the facility", href: "#facility" },
  { slot: "home_hero_synthesis", fallback: "/W/assets/tide-lab-hero-synthesis_18f9f3f8.jpg", kicker: "02 / PEPTIDE SCIENCE", title: <>Complex sequences,<br /><em>clear control.</em></>, body: "From di-peptides to 40+ amino acid sequences, Tide organizes technical requirements with precision.", action: "Meet our laboratory", href: "/laboratory" },
  { slot: "home_hero_batch", fallback: "/W/assets/tide-lab-hero-batch_0a8104c6.jpg", kicker: "03 / BATCH DOCUMENTATION", title: <>Every batch leaves<br /><em>a visible record.</em></>, body: "Review product models, batch presentation, COA documentation, and delivery milestones before you order.", action: "Review COA reports", href: "/coa" },
  { slot: "home_hero_analytical", fallback: "/W/assets/tide-lab-hero-analytical_1e7ff08d.jpg", kicker: "04 / FACTORY EVIDENCE", title: <>See the work<br /><em>before partnership.</em></>, body: "Real Guangzhou production evidence, organized handling, and direct communication for Western B2B buyers.", action: "Chat on WhatsApp", href: "https://wa.me/85253929189" },
] as const;
  ...
  return (
    <SiteLayout>
      <main>
        ...
        <section className="section laboratory-order-section about-order-section homepage-trust-section">
          <div className="container">
            ...
            <div className="homepage-trust-feature-grid">
              <figure><img src={managed.get("home_order_quality", "/W/assets/tide-order-quality-control_16f20e7b.jpg")} alt="Chinese Asian quality specialist reviewing peptide order and batch documentation" /><figcaption><span>ORDER DOCUMENTATION</span><strong>Payment begins with a clear record.</strong></figcaption></figure>
        ...
        <section className="section about-peptide-visuals"><div className="container"><div className="about-visual-head"><span className="archive-label">{copy.get("about.visual.kicker", "PEPTIDE FACILITY / Peptide Factory Field View")}</span><h2>{copy.get("about.visual.title", "From R&D to production,")}<br /><em>{copy.get("about.visual.titleEm", "every step has a corresponding environment.")}</em></h2><p>{copy.get("about.visual.intro", "Tide offers more than written introductions: customers can see the environments supporting peptide R&D, clean production, and quality control.")}</p></div><div className="about-peptide-grid"><figure className="about-peptide-card about-peptide-feature"><img src={managed.get("about_facility_rd", "/W/assets/tide-about-rd-coordination_0c7c2f18.jpg")} alt="Peptide synthesis research and development" /><figcaption><span>01 / SYNTHESIS & R&D</span><strong>Peptide R&D and Synthesis Coordination</strong><p>We establish a clear production foundation around product planning, R&D documentation, and specification confirmation.</p></figcaption></figure><figure className="about-peptide-card"><img src={managed.get("about_facility_cleanroom", "/W/assets/tide-about-controlled-cleanroom_30949468.jpg")} alt="Cleanroom pharmaceutical manufacturing" /><figcaption><span>02 / CLEANROOM</span><strong>Cleanroom Production Environment</strong><p>Controlled environmental management supports peptide production and batch operations.</p></figcaption></figure><figure className="about-peptide-card"><img src={managed.get("about_facility_lyophilization", "/W/assets/tide-about-lyophilization-process_903a0427.jpg")} alt="Freeze drying peptide vials" /><figcaption><span>03 / LYOPHILIZATION</span><strong>Lyophilization and Product Form</strong><p>We align product form, pack size, and related documentation.</p></figcaption></figure><figure className="about-peptide-card"><img src={managed.get("about_facility_production", "/W/assets/lyophilization_e21206db.png")} alt="Peptide production equipment" /><figcaption><span>04 / PRODUCTION</span><strong>Production Equipment and Process</strong><p>Equipment coordination and process management support consistent peptide delivery.</p></figcaption></figure></div></div></section>

        <section className="section client-visit-section"><div className="container"><div className="client-visit-head"><div><span className="archive-label">{copy.get("about.visit.kicker", "FACTORY EVIDENCE / GUANGZHOU SITE")}</span><h2>{copy.get("about.visit.title", "Real environments,")}<br /><em>{copy.get("about.visit.titleEm", "visible before the partnership begins.")}</em></h2></div><p>{copy.get("about.visit.intro", "Selected frames from Tide's Guangzhou production site. The homepage uses only cleanroom operations, local factory staff, product handling, and equipment evidence—no generic Western stock imagery.")}</p></div><div className="client-visit-grid"><figure className="client-visit-card"><img src={managed.get("about_visit_equipment_video_clean", "/W/assets/visit-equipment-dialogue-4x3_6719123d.jpg")} alt="Asian Tide factory staff discussing peptide production equipment in a cleanroom" /><figcaption><span>01 / CLIENT VISIT · EQUIPMENT REVIEW</span><strong>Factory equipment review</strong></figcaption></figure><figure className="client-visit-card"><img src={managed.get("about_visit_observation_video_clean", "https://tidbioconsol-7pvrbanu.manus.space/manus-storage/tide-factory-visit-process-review-2026-08_43a6b1a2.jpg")} alt="Asian Tide factory staff observing a peptide production process" /><figcaption><span>02 / CLIENT VISIT · PROCESS OBSERVATION</span><strong>Production process observation</strong></figcaption></figure><figure className="client-visit-card"><img src={managed.get("about_visit_product_photo_clean", "https://tidbioconsol-7pvrbanu.manus.space/manus-storage/tide-factory-visit-vial-documentation-2026-08_549f896e.jpg")} alt="Customer reviewing peptide vial tray with Asian Tide factory staff during a Guangzhou factory visit" /><figcaption><span>03 / CLIENT VISIT · PRODUCT REVIEW</span><strong>Product and vial-tray review</strong></figcaption></figure></div></div></section>
