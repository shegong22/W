...
export default function Contact() {
  ...
  const whatsappNumber = "85253929189";
  ...
  const submit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const message = [
      "New inquiry from tide-peptide.com",
      "",
      `Name: ${name}`,
      `Email: ${email}`,
