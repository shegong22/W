...
export default function Contact() {
  ...
  const submit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!inquiryApiUrl) {
      setSubmitError("The online inquiry service is not configured. Please email bebaapicones@gmail.com or contact us on WhatsApp.");
      return;
    }
